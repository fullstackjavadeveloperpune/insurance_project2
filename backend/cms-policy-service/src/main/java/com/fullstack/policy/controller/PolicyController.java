package com.fullstack.policy.controller;
...
import com.fullstack.policy.resource.PolicyResource;
...
public class PolicyController {
	...
	@GetMapping("/fetch")
	public ResponseEntity<PolicyResponseDto> fetchPolicy(@RequestParam("policyId") Integer policyId) {
		return policyResource.fetchPolicy(policyId);
	}
