...
import com.fullstack.user.resource.UserResource;
...
public class UserController {
	...
	public ResponseEntity<UserLoginResponse> login(@RequestBody UserLoginRequest userLoginRequest) {
		...
		log.info("Inside Controller"+ userLoginRequest.getEmailId()+""+userLoginRequest.getPassword()+""+userLoginRequest.getRole());
