...
import ViewInspectorClaims from "./ClaimComponent/ViewInspectorClaims";
import ViewAllInspectors from "./UserComponent/ViewAllInspectors";
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        />
        <Route
          path="/Inspector/policy/customer/claims"
          element={<ViewInspectorClaims />}
        />
      </Routes>
    </div>
  );
